...
if __name__ == "__main__":
    ...
    prompt = input("Would you like to play a game? enter a YES or Y to play: ").upper()
    if prompt == "YES" or prompt == "Y":
        play_game = int(input("guess a number: "))
        winner = randint(1, 5)
        guess.guessing_game(play_game, winner)
        print(name + ", great, you got the right answer!")